...
var DrawingTools = {
    ...
    *******************************/
    ...
    DrawingManager: function (map,shapeLayer, edittingLayer,options) {
        /// <signature>
        /// <summary>
      ...
      var   currentShape,
        ...
        var _options = {
            ...
            toolbarOptions: {
                ...
                drawingModes: ['polygon', 'circle', 'rectangle', 'erase', 'edit'],
        ...
        this.setDrawingMode = function (mode) {
            ...
            if (drawingMode) {
                    ...
                    for (var i = 0; i < shapeLayer.getLength() ; i++) {
                        ...
                        if (s.getIcon) {
                            ...
                            eventIds.push(Microsoft.Maps.Events.addHandler(s, 'click', function (e) {
                                if (e.target) {
                                    _options.events.drawingSelected(e.target);
                ...
                eventIds.push(Microsoft.Maps.Events.addHandler(map, 'keyup', function (e) {
                 ...
                 eventIds.push(Microsoft.Maps.Events.addHandler(map, 'rightclick', function (e) {
                        self.setDrawingMode(null);
                  }));
            }
        };
